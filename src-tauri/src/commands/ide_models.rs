...
pub fn builtin_models() -> Vec<IdeModel> {
    vec![
        ...
        // GPT-5.6 Luna
        ma("gpt-5-6-luna-none", "GPT-5.6 Luna No Thinking", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-none-priority", "GPT-5.6 Luna No Thinking Fast", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-low", "GPT-5.6 Luna Low Thinking", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-low-priority", "GPT-5.6 Luna Low Thinking Fast", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-medium", "GPT-5.6 Luna Medium Thinking", "openai", true, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-medium-priority", "GPT-5.6 Luna Medium Thinking Fast", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-high", "GPT-5.6 Luna High Thinking", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-high-priority", "GPT-5.6 Luna High Thinking Fast", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-xhigh", "GPT-5.6 Luna XHigh Thinking", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-xhigh-priority", "GPT-5.6 Luna XHigh Thinking Fast", "openai", false, "gpt-5.6-luna"),
        ma("gpt-5-6-luna-max", "GPT-5.6 Luna Max Thinking", "openai", false, "gpt-5.6-luna"),
        // GPT-5.6 Sol
        ma("gpt-5-6-sol-none", "GPT-5.6 Sol No Thinking", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-none-priority", "GPT-5.6 Sol No Thinking Fast", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-low", "GPT-5.6 Sol Low Thinking", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-low-priority", "GPT-5.6 Sol Low Thinking Fast", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-medium", "GPT-5.6 Sol Medium Thinking", "openai", true, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-medium-priority", "GPT-5.6 Sol Medium Thinking Fast", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-high", "GPT-5.6 Sol High Thinking", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-high-priority", "GPT-5.6 Sol High Thinking Fast", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-xhigh", "GPT-5.6 Sol XHigh Thinking", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-xhigh-priority", "GPT-5.6 Sol XHigh Thinking Fast", "openai", false, "gpt-5.6-sol"),
        ma("gpt-5-6-sol-max", "GPT-5.6 Sol Max Thinking", "openai", false, "gpt-5.6-sol"),
        // GPT-5.6 Terra
        ma("gpt-5-6-terra-none", "GPT-5.6 Terra No Thinking", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-none-priority", "GPT-5.6 Terra No Thinking Fast", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-low", "GPT-5.6 Terra Low Thinking", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-low-priority", "GPT-5.6 Terra Low Thinking Fast", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-medium", "GPT-5.6 Terra Medium Thinking", "openai", true, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-medium-priority", "GPT-5.6 Terra Medium Thinking Fast", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-high", "GPT-5.6 Terra High Thinking", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-high-priority", "GPT-5.6 Terra High Thinking Fast", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-xhigh", "GPT-5.6 Terra XHigh Thinking", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-xhigh-priority", "GPT-5.6 Terra XHigh Thinking Fast", "openai", false, "gpt-5.6-terra"),
        ma("gpt-5-6-terra-max", "GPT-5.6 Terra Max Thinking", "openai", false, "gpt-5.6-terra"),
        ...
        // Grok 4.5
        ma("grok-4-5-low", "Grok 4.5 Low", "xai", false, "grok-4.5"),
        ma("grok-4-5-medium", "Grok 4.5 Medium", "xai", true, "grok-4.5"),
        ma("grok-4-5-high", "Grok 4.5 High", "xai", false, "grok-4.5"),
        // ── 其他厂商 ──
        ...
        ma("swe-1-7", "SWE-1.7", "windsurf", false, "swe-1.7"),
        m(
            "swe-1-7-lightning",
            "SWE-1.7 Lightning",
            "windsurf",
        ...
        // ── GPT-6 (Astra 系列) ──
        ma("gpt-6-astra", "GPT-6 Astra", "openai", true, "gpt-6-astra"),
        ma("gpt-6-astra-none", "GPT-6 Astra No Thinking", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-low", "GPT-6 Astra Low Thinking", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-medium", "GPT-6 Astra Medium Thinking", "openai", true, "gpt-6-astra"),
        ma("gpt-6-astra-high", "GPT-6 Astra High Thinking", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-xhigh", "GPT-6 Astra XHigh Thinking", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-max", "GPT-6 Astra Max Thinking", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-none-priority", "GPT-6 Astra No Thinking Fast", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-low-priority", "GPT-6 Astra Low Thinking Fast", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-medium-priority", "GPT-6 Astra Medium Thinking Fast", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-high-priority", "GPT-6 Astra High Thinking Fast", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-xhigh-priority", "GPT-6 Astra XHigh Thinking Fast", "openai", false, "gpt-6-astra"),
        ma("gpt-6-astra-max-priority", "GPT-6 Astra Max Thinking Fast", "openai", false, "gpt-6-astra"),
        // ── GPT-5.6 基础通用槽位 ──
        ma("gpt-5.6-sol", "GPT-5.6 Sol", "openai", true, "gpt-5.6-sol"),
        ma("gpt-5.6-luna", "GPT-5.6 Luna", "openai", true, "gpt-5.6-luna"),
        ma("gpt-5.6-terra", "GPT-5.6 Terra", "openai", true, "gpt-5.6-terra"),
        // ── Claude 5 系列 (Opus 5 / Sonnet 5 / Fable 5) ──
        ma("claude-opus-5", "Claude Opus 5", "anthropic", true, "claude-opus-5"),
        ma("claude-opus-5-low", "Claude Opus 5 Low", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-medium", "Claude Opus 5 Medium", "anthropic", true, "claude-opus-5"),
        ma("claude-opus-5-high", "Claude Opus 5 High", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-xhigh", "Claude Opus 5 XHigh", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-max", "Claude Opus 5 Max", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-low-fast", "Claude Opus 5 Low Fast", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-medium-fast", "Claude Opus 5 Medium Fast", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-high-fast", "Claude Opus 5 High Fast", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-xhigh-fast", "Claude Opus 5 XHigh Fast", "anthropic", false, "claude-opus-5"),
        ma("claude-opus-5-max-fast", "Claude Opus 5 Max Fast", "anthropic", false, "claude-opus-5"),
        ma("claude-sonnet-5", "Claude Sonnet 5", "anthropic", true, "claude-sonnet-5"),
        ma("claude-sonnet-5-low", "Claude Sonnet 5 Low", "anthropic", false, "claude-sonnet-5"),
        ma("claude-sonnet-5-medium", "Claude Sonnet 5 Medium", "anthropic", true, "claude-sonnet-5"),
        ma("claude-sonnet-5-high", "Claude Sonnet 5 High", "anthropic", false, "claude-sonnet-5"),
        ma("claude-sonnet-5-xhigh", "Claude Sonnet 5 XHigh", "anthropic", false, "claude-sonnet-5"),
        ma("claude-sonnet-5-max", "Claude Sonnet 5 Max", "anthropic", false, "claude-sonnet-5"),
        ma("claude-fable-5", "Claude Fable 5", "anthropic", true, "claude-fable-5"),
        ma("claude-fable-5-1", "Claude Fable 5.1", "anthropic", true, "claude-fable-5-1"),
        ma("claude-fable-5-1-low", "Claude Fable 5.1 Low", "anthropic", false, "claude-fable-5-1"),
        ma("claude-fable-5-1-medium", "Claude Fable 5.1 Medium", "anthropic", true, "claude-fable-5-1"),
        ma("claude-fable-5-1-high", "Claude Fable 5.1 High", "anthropic", false, "claude-fable-5-1"),
        ma("claude-fable-5-1-xhigh", "Claude Fable 5.1 XHigh", "anthropic", false, "claude-fable-5-1"),
        ma("claude-fable-5-1-max", "Claude Fable 5.1 Max", "anthropic", false, "claude-fable-5-1"),
        // ── Grok 4.6 系列 ──
        ma("grok-4.6", "Grok 4.6", "xai", true, "grok-4.6"),
        ma("grok-4-6-low", "Grok 4.6 Low", "xai", false, "grok-4.6"),
        ma("grok-4-6-medium", "Grok 4.6 Medium", "xai", true, "grok-4.6"),
        ma("grok-4-6-high", "Grok 4.6 High", "xai", false, "grok-4.6"),
        ma("grok-4-6-xhigh", "Grok 4.6 XHigh", "xai", false, "grok-4.6"),
        // ── 国模与开源新旗舰 ──
        ma("deepseek-v4-pro", "DeepSeek V4 Pro", "other", true, "deepseek-v4-pro"),
        ma("deepseek-v4-flash", "DeepSeek V4 Flash", "other", true, "deepseek-v4-flash"),
        ma("glm-5.3", "GLM-5.3", "other", true, "glm-5.3"),
        ma("glm-5-3-low", "GLM-5.3 Low", "other", false, "glm-5.3"),
        ma("glm-5-3-high", "GLM-5.3 High", "other", false, "glm-5.3"),
        ma("glm-5-3-max", "GLM-5.3 Max", "other", true, "glm-5.3"),
        ma("kimi-k3", "Kimi K3", "other", true, "kimi-k3"),
        ma("kimi-k3-low", "Kimi K3 Low", "other", false, "kimi-k3"),
        ma("kimi-k3-high", "Kimi K3 High", "other", true, "kimi-k3"),
        ma("kimi-k3-max", "Kimi K3 Max", "other", false, "kimi-k3"),
        ma("gemini-3.7-flash-high", "Gemini 3.7 Flash High", "google", true, "gemini-3.7-flash-high"),
        ma("gemini-3.8-flash-high", "Gemini 3.8 Flash High", "google", true, "gemini-3.8-flash-high"),
        ma("nemotron-3-ultra-high", "Nemotron 3 Ultra High", "other", false, "nemotron-3-ultra-high"),
        m("inkling-medium", "Inkling Medium", "windsurf", false),
        m("inkling-high", "Inkling High", "windsurf", false),
        m("inkling-max", "Inkling Max", "windsurf", false),
    ]
}
